...
@friday.on(
    friday_on_cmd(pattern=r"(set|get|del) var(?: |$)(.*)(?: |$)([\s\S]*)",
              outgoing=True))
@friday.on(
    friday_sudo_cmd(pattern=r"(set|get|del) var(?: |$)(.*)(?: |$)([\s\S]*)",
             allow_sudo=True))
...
@friday.on(friday_sudo_cmd(pattern="usage$", allow_sudo=True))
...
@friday.on(friday_sudo_cmd(pattern="logs$", allow_sudo=True))
